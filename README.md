...
- ارسال پیام عمومی با حفظ قالب‌بندی به کاربران ربات
- بکاپ خودکار زمان‌بندی‌شده، ارسال به مدیر و بازیابی امن از داخل ربات
- اعلان خودکار نزدیک‌شدن به پایان حجم یا اعتبار اکانت
